    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="br-section-label">Ordenar Banner publicitarios home</h6>
            ...
            <table class="table mg-b-0  table-colored table-dark">
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <td style="<?=$bgcolor;?>">
                      <a href="{{route('aab-bann1-delete-pro',[$reg->aab_bann1_id,$reg->aab_bann1_token])}}"><button type="button" class="btn btn-danger btn-sm">Elim</button></a></td>
