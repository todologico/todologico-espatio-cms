                 ...
                 <td style="<?=$bgcolor;?>">
                  ...
                  <td style="<?=$bgcolor;?>" v-bind:style="">
                    ...
                    <?if($reg->aab_bann1_enable=='1'){?>dfdfd
                      ...
                      <button type="button" v-cloak :[b{{$reg->aab_bann1_id}}]="true"  v-if="{{$reg->aab_bann1_id}}" @click="ShowHideBannersAR({{$reg->aab_bann1_id}},'{{$reg->aab_bann1_token}}','1')" class="btn btn-success btn-sm"><i class="fa fa-power-off" aria-hidden="true"></i> ON222</button>
                      
                      <button type="button" v-cloak  :[b{{$reg->aab_bann1_id}}]="false"  v-else="{{$reg->aab_bann1_id}}"  @click="ShowHideBannersAR({{$reg->aab_bann1_id}},'{{$reg->aab_bann1_token}}','2')"  class="btn btn-danger btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> OFF111</button>         
