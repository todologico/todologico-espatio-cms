    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          ...
          <p class="br-section-text">Enter new images. Check the size before uploading your file.</p>
          ...
          <div class="form-layout form-layout-6">
            ...
            <div class="row no-gutters">
              <div class="col-5 col-sm-4">
               <?if(isset($products[0]->zgfcp_prod1_image1)){?><a href="{{route('zgfcp-prod1-images-delete-pro',[$products[0]->zgfcp_prod1_id,$products[0]->zgfcp_prod1_token,1])}}"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Del</button></a><?}?>
              </div>
            ...
            <div class="row no-gutters">
              <div class="col-5 col-sm-4">
                 <?if(isset($products[0]->zgfcp_prod1_image2)){?><a href="{{route('zgfcp-prod1-images-delete-pro',[$products[0]->zgfcp_prod1_id,$products[0]->zgfcp_prod1_token,2])}}"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Del</button></a><?}?>
              </div>
            ...
            <div class="row no-gutters">
              <div class="col-5 col-sm-4">
               <button type="button" class="btn btn-primary" onclick="submit();"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save Images</button>
              </div>
