     ...
     @include('zgfcp_cate1.zgfcp_cate1_menu')
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          ...
          <form method="POST" action="{{route('zgfcp-cate1-images-update-pro')}}" enctype="multipart/form-data"> {{ csrf_field() }} 
          ...
          <div class="form-layout form-layout-6">
            ...
            <div class="row no-gutters">
              <div class="col-5 col-sm-4">
               <?if(isset($categories[0]->zgfcp_cate1_image1)){?><a href="{{route('zgfcp-cate1-images-delete-pro',[$categories[0]->zgfcp_cate1_id,$categories[0]->zgfcp_cate1_token,1])}}"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Elim</button></a><?}?>
              </div>
            ...
            <!-- <div class="row no-gutters">
              <div class="col-5 col-sm-4">
                 <?if(isset($categories[0]->zgfcp_cate1_image2)){?><a href="{{route('zgfcp-cate1-images-delete-pro',[$categories[0]->zgfcp_cate1_id,$categories[0]->zgfcp_cate1_token,2])}}"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Elim</button></a><?}?>
              </div>
              
              <div class="col-3 col-sm-4"> <?if(isset($categories[0]->zgfcp_cate1_image2)){?><img src="{{url('/')}}/storage/uploaddir/{{$categories[0]->zgfcp_cate1_image2}}" style="height:80px;" /><?}?>
              </div>
