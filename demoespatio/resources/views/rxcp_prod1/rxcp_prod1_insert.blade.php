        ...
        <div class="br-section-wrapper">
          ...
          <div class="form-layout form-layout-6">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-7 col-sm-8"> <input class="form-control" type="text" name="rxcp_prod1_code" maxlength="60" placeholder="Product code" required></div>
            </div>   
             ...
             <div class="row no-gutters">
              ...
              <div class="col-7 col-sm-8"> <input class="form-control" type="number" name="rxcp_prod1_price1" maxlength="10" placeholder="Product Price" required></div>
            </div>     
            ...
            <div class="row no-gutters">
              ...
              <div class="col-7 col-sm-8"> <input class="form-control" type="text" name="rxcp_prod1_product" maxlength="255" placeholder="Product Name" required></div>
            </div>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-7 col-sm-8"> <input class="form-control" type="text" name="rxcp_prod1_title1" maxlength="255" placeholder="Product Title" required></div>
            </div>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-7 col-sm-8"> <input class="form-control" type="text" name="rxcp_prod1_title2" maxlength="255" placeholder="Product Title" required></div>
            </div>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-7 col-sm-8"> <input class="form-control" type="text" name="rxcp_prod1_title3" maxlength="255" placeholder="Product Title" required></div>
            </div>                               
