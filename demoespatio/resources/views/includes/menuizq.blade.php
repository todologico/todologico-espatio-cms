  <div class="br-logo"><a href="{{route('dashboard')}}"><span>[</span>Espatio CMS<span>]</span></a></div>
    <div class="br-sideleft sideleft-scrollbar">
      ...
      <label class="sidebar-label pd-x-10 mg-t-25 mg-b-20 tx-info">Statistics Data</label>

      <div class="info-list">
        <div class="info-list-item">
          <div>
            <p class="info-list-label">Users</p>
        ...
        <div class="info-list-item">
          <div>
            <p class="info-list-label">Products</p>
        ...
        <div class="info-list-item">
          <div>
            <p class="info-list-label">Profits</p>
