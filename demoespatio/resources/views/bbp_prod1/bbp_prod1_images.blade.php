    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          ...
          <form method="POST" action="{{route('bbp-prod1-images-update-pro')}}" enctype="multipart/form-data"> {{ csrf_field() }} 
          ...
          <div class="form-layout form-layout-6">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-4 col-sm-4"> <input class="form-control-file" type="file" name="bbp_prod1_photo[]" placeholder="Imagen">
              </div>
            ...
            <div class="row no-gutters">
              <div class="col-5 col-sm-4">
                 <?if(isset($products[0]->bbp_prod1_image2)){?><a href="{{route('bbp-prod1-images-delete-pro',[$products[0]->bbp_prod1_id,$products[0]->bbp_prod1_token,2])}}"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i> Elim</button></a><?}?>
              </div>
              
              <div class="col-3 col-sm-4"> <?if(isset($products[0]->bbp_prod1_image2)){?><img src="{{url('/')}}/storage/uploaddir/{{$products[0]->bbp_prod1_image2}}" style="height:80px;" /><?}?>
              </div>
