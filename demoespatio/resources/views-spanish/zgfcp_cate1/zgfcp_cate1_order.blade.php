            ...
            <table class="table mg-b-0  table-colored table-dark">
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <td style="<?=$bgcolor;?>">
                      <a href="{{route('zgfcp-cate1-delete-pro',[$reg->zgfcp_cate1_id,$reg->zgfcp_cate1_token])}}"><button type="button" class="btn btn-danger btn-sm">Elim</button></a></td>
                  
                  <td style="<?=$bgcolor;?>">{{$reg->zgfcp_cate1_id}}</td>
                 
                  <td style="<?=$bgcolor;?>">{{$reg->zgfcp_fami1_family}}</td>                  
                  <td style="<?=$bgcolor;?>">{{$reg->zgfcp_cate1_category}}</td>                  
                  
                  <td style="<?=$bgcolor;?>"><?if(isset($reg->zgfcp_cate1_image1)){?><img src="{{url('/')}}/storage/uploaddir/{{$reg->zgfcp_cate1_image1}}" style="height:80px;" /><?}?></td>
                  ...
                  <td style="<?=$bgcolor;?>">{{$reg->zgfcp_cate1_order}}</td> 
                  
                  <td style="<?=$bgcolor;?>">                     

                        <select name="order" ng-model="order{{$reg->zgfcp_cate1_id}}" ng-change="OrderAR('{{$reg->zgfcp_cate1_id}}','{{$reg->zgfcp_cate1_token}}',this.order{{$reg->zgfcp_cate1_id}})" data-placeholder="Ordenar">
